...
func getU32(plaintext []uint8, index int) uint32 {
	return (uint32(plaintext[index]) << 24) ^ (uint32(plaintext[index+1]) << 16) ^ (uint32(plaintext[index+2]) << 8) ^ (uint32(plaintext[index+3]))
}
